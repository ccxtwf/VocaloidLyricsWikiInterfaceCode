  ...
  */
  ...
  function loadMessages() {
    ...
    var mock = {
      msg: function (key) {
        return {
          plain: function () { return fallbackMessages[key]; }
        };
      }
    };
  ...
  function run() {
    if (!i18n || !parserFunctions || !loadedWikipage) {
      return; 	// Wait until all events have finished loading
    }
    init(i18n);
  }
